...
static char	**get_path_dirs(t_gc *gc, t_env *env)
{
	char	*path;
	char	**path_dirs;
...
static char	*build_full_path(t_gc *gc, char *path_dir, char *command)
{
	char	*temp;
	char	*full_path;
...
static char	*check_command_in_path(t_gc *gc, char *command, char *path_dir)
{
	char	*full_path;
...
static char	*handle_absolute_path(t_gc *gc, char *command)
{
...
static char	*search_in_path_dirs(t_gc *gc, char **path_dirs, char *command)
{
	char	*full_path;
	int		i;
